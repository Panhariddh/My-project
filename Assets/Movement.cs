...
public class Movement : MonoBehaviour
{
    ...
    void Cube() // jump one time when clicked once 
    {
        generic.createGamemode(rb, this, true, 19.5269f, 9.057f, true, false, 409.1f);
    }

    void Ship() //  fly when hold leftclick
    {
